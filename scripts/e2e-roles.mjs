...
const CREDS = { email: process.env.SMOKE_EMAIL ?? 'june@tailor.tech', password: process.env.SMOKE_PASSWORD ?? 'admin123' }
const STAFF_CREDS = { email: process.env.SMOKE_STAFF_EMAIL ?? 'staff@wbr.com', password: process.env.SMOKE_STAFF_PASSWORD ?? 'staff123' }
