...
async function main() {
 ...
 const speakerDefs: { id: string; name: string; bio: string; company: string; jobTitle: string; role: string; twitterHandle?: string; linkedinUrl?: string; }[] = [
 // ── ERP (9) ───────────────────────────────────────────────────────────────
 { id: 'spk-12', name: 'Thomas Bergström', bio: 'Builds modern ERP systems that connect commerce, inventory, and finance for high-growth brands.', company: 'Tailor ERP', jobTitle: 'Head of Solutions', role: TOPICS[0] },
 { id: 'spk-3', name: 'Priya Patel', bio: 'CTO of a fast-growing fintech startup passionate about developer experience, platform engineering, and engineering cultures that scale.', company: 'FinFlow', jobTitle: 'CTO', role: TOPICS[0], twitterHandle: '@priyapatel_dev' },
 { id: 'spk-30', name: 'Patrick O\'Sullivan', bio: 'Retail analytics leader using data to predict trends, optimize inventory, and reduce markdowns.', company: 'SSENSE', jobTitle: 'Director of Analytics', role: TOPICS[0] },
 { id: 'spk-46', name: 'Michael Chang', bio: 'Product information management expert enabling brands to sell consistently across 50+ channels.', company: 'Salsify', jobTitle: 'Director of Engineering', role: TOPICS[0] },
 { id: 'spk-56', name: 'Kevin Wu', bio: 'Inventory planning and demand forecasting expert helping brands eliminate stockouts and overstock.', company: 'Inventory Planner', jobTitle: 'CEO', role: TOPICS[0] },
 { id: 'spk-70', name: 'Ben Gallagher', bio: 'Retail analytics dashboard builder giving merchants real-time visibility into sales and inventory.', company: 'Looker', jobTitle: 'Commerce Analytics Lead', role: TOPICS[0] },
 { id: 'spk-34', name: 'Samuel Adeyemi', bio: 'Cross-border commerce expert helping brands navigate international expansion, taxes, and logistics.', company: 'Global-e', jobTitle: 'Head of Strategy', role: TOPICS[0] },
 { id: 'spk-61', name: 'Rosa Fernandez', bio: 'Localization expert helping global brands adapt their storefronts for language, culture, and currency.', company: 'Weglot', jobTitle: 'Head of Commerce', role: TOPICS[0] },
 { id: 'spk-43', name: 'Ingrid Larsson', bio: 'B2B commerce strategist helping wholesale brands digitize their ordering and expand into DTC.', company: 'Centra', jobTitle: 'VP of Sales', role: TOPICS[0] },

 // ── Commerce & Platforms (9) ──────────────────────────────────────────────
 { id: 'spk-5', name: 'Elena Rodriguez', bio: 'Expert in omnichannel retail strategy with a decade of experience transforming brick-and-mortar brands into digital-first powerhouses.', company: 'Shopify', jobTitle: 'VP of Commerce Strategy', role: TOPICS[1] },
 { id: 'spk-6', name: 'David Park', bio: 'Pioneering headless commerce architectures that power some of the fastest-growing DTC brands in North America.', company: 'BigCommerce', jobTitle: 'Director of Engineering', role: TOPICS[1] },
 { id: 'spk-25', name: 'Alex Nguyen', bio: 'Full-stack commerce developer and educator teaching brands how to build composable storefronts.', company: 'Shopify', jobTitle: 'Staff Developer Advocate', role: TOPICS[1] },
 { id: 'spk-32', name: 'Nathan Brooks', bio: 'Marketplace operations expert scaling multi-vendor platforms from startup to $100M+ GMV.', company: 'Faire', jobTitle: 'VP of Operations', role: TOPICS[1] },
 { id: 'spk-40', name: 'Chris Bennett', bio: 'Headless CMS pioneer enabling brands to deliver content-rich commerce experiences across every channel.', company: 'Contentful', jobTitle: 'Head of Commerce', role: TOPICS[1] },
 { id: 'spk-52', name: 'Victor Onyeka', bio: 'Marketplace integration specialist connecting brands to Amazon, Walmart, and emerging retail platforms.', company: 'ChannelAdvisor', jobTitle: 'VP of Partnerships', role: TOPICS[1] },
 { id: 'spk-58', name: 'Brian Foster', bio: 'Composable commerce architect helping enterprise brands break free from monolithic platforms.', company: 'commercetools', jobTitle: 'Solutions Architect', role: TOPICS[1] },
 { id: 'spk-68', name: 'Adrian Pope', bio: 'API-first commerce builder helping brands create custom storefronts with maximum flexibility.', company: 'Medusa', jobTitle: 'Co-Founder', role: TOPICS[1] },
 { id: 'spk-48', name: 'Finn O\'Connor', bio: 'Accessibility advocate ensuring ecommerce experiences are inclusive and WCAG-compliant.', company: 'Shopify', jobTitle: 'Accessibility Lead', role: TOPICS[1] },

 // ── Marketing & Growth (9) ────────────────────────────────────────────────
 { id: 'spk-9', name: 'Mei Lin Zhang', bio: 'Data scientist turned marketer, building predictive models that drive personalized customer journeys at scale.', company: 'Klaviyo', jobTitle: 'Senior Data Scientist', role: TOPICS[2] },
 { id: 'spk-14', name: 'Jamal Washington', bio: 'SMS and mobile marketing strategist who has driven $500M+ in attributable revenue for DTC brands.', company: 'Attentive', jobTitle: 'VP of Strategy', role: TOPICS[2] },
 { id: 'spk-23', name: 'Marco Rossi', bio: 'SMS marketing automation expert helping Shopify merchants achieve 25x+ ROI on text campaigns.', company: 'Postscript', jobTitle: 'Head of Growth', role: TOPICS[2] },
 { id: 'spk-26', name: 'Hannah Becker', bio: 'Conversion rate optimization expert who has run 10,000+ A/B tests across leading ecommerce brands.', company: 'BigCommerce', jobTitle: 'Head of CRO', role: TOPICS[2] },
 { id: 'spk-42', name: 'Tyler Robinson', bio: 'Loyalty and rewards program architect who has designed programs with 10M+ active members.', company: 'LoyaltyLion', jobTitle: 'Co-Founder', role: TOPICS[2] },
 { id: 'spk-45', name: 'Lena Fischer', bio: 'Influencer commerce strategist building scalable creator programs that drive authentic brand growth.', company: 'Grin', jobTitle: 'VP of Strategy', role: TOPICS[2] },
 { id: 'spk-47', name: 'Aaliyah Davis', bio: 'Email marketing automation specialist driving 30%+ of revenue through lifecycle campaigns.', company: 'Klaviyo', jobTitle: 'Head of Email Strategy', role: TOPICS[2] },
 { id: 'spk-54', name: 'Daniel Okafor', bio: 'Performance marketing expert driving efficient customer acquisition through paid social and search.', company: 'Triple Whale', jobTitle: 'Head of Product', role: TOPICS[2] },
 { id: 'spk-60', name: 'Sean Murphy', bio: 'Retail media network builder helping brands monetize their first-party data through on-site advertising.', company: 'Criteo', jobTitle: 'Head of Retail Media', role: TOPICS[2] },

 // ── Logistics & Fulfillment (9) ───────────────────────────────────────────
 { id: 'spk-7', name: 'Amira Hassan', bio: 'Supply chain optimization expert helping brands reduce fulfillment costs while improving delivery speed.', company: 'ShipStation', jobTitle: 'Head of Product', role: TOPICS[3] },
 { id: 'spk-8', name: 'Ryan Cooper', bio: 'Turned returns from a cost center into a growth engine for over 200 Shopify Plus brands.', company: 'Loop Returns', jobTitle: 'Co-Founder & CEO', role: TOPICS[3] },
 { id: 'spk-15', name: 'Sophie Dubois', bio: 'Post-purchase experience designer focused on turning shipping anxiety into brand loyalty moments.', company: 'Narvar', jobTitle: 'Head of Experience Design', role: TOPICS[3] },
 { id: 'spk-16', name: 'Kenji Tanaka', bio: 'Fulfillment network architect connecting brands with optimal 3PL partners across global markets.', company: 'Extensiv', jobTitle: 'CTO', role: TOPICS[3] },
 { id: 'spk-20', name: 'Nadia Petrova', bio: 'Shipment tracking and logistics expert helping brands deliver transparency and trust at every touchpoint.', company: 'AfterShip', jobTitle: 'Head of Product', role: TOPICS[3] },
 { id: 'spk-36', name: 'Andre Williams', bio: 'Warehouse automation specialist deploying robotics and AI to transform fulfillment center efficiency.', company: 'ShipBob', jobTitle: 'CTO', role: TOPICS[3] },
 { id: 'spk-49', name: 'Priyanka Sharma', bio: 'Warehouse management systems expert optimizing pick, pack, and ship operations for high-volume brands.', company: 'ShipStation', jobTitle: 'Director of Solutions', role: TOPICS[3] },
 { id: 'spk-66', name: 'Omar Bakari', bio: 'Warehouse robotics engineer deploying autonomous systems that triple pick-and-pack throughput.', company: 'Locus Robotics', jobTitle: 'Head of Integrations', role: TOPICS[3] },
 { id: 'spk-71', name: 'Chiara Bianchi', bio: 'Omnichannel fulfillment strategist helping brands offer BOPIS, ship-from-store, and same-day delivery.', company: 'Manhattan Associates', jobTitle: 'Director of Product', role: TOPICS[3] },

 // ── AI & Data (9) ─────────────────────────────────────────────────────────
 { id: 'spk-2', name: 'Marcus Williams', bio: 'Leads the AI/ML platform team and has published research on large language models. Previously at Google Brain and OpenAI.', company: 'DeepTech Labs', jobTitle: 'Head of AI Platform', role: TOPICS[4], linkedinUrl: 'https://linkedin.com/in/marcuswilliams' },
 { id: 'spk-17', name: 'Ava Mitchell', bio: 'Personalization expert using AI to create unique shopping experiences that increase AOV and lifetime value.', company: 'Rebuy Engine', jobTitle: 'Head of AI', role: TOPICS[4] },
 { id: 'spk-18', name: 'Ibrahim Koné', bio: 'Site search and merchandising specialist who has optimized product discovery for 500+ online retailers.', company: 'Searchspring', jobTitle: 'VP of Engineering', role: TOPICS[4] },
 { id: 'spk-39', name: 'Zara Patel', bio: 'Customer data platform expert unifying first-party data to power hyper-personalized marketing.', company: 'Segment', jobTitle: 'Commerce Solutions Lead', role: TOPICS[4] },
 { id: 'spk-59', name: 'Ananya Gupta', bio: 'Voice commerce researcher exploring how conversational AI is reshaping how consumers discover and buy products.', company: 'Google Cloud', jobTitle: 'AI Research Lead', role: TOPICS[4] },
 { id: 'spk-69', name: 'Samira Youssef', bio: 'Product recommendation engine architect using collaborative filtering to boost cross-sell revenue.', company: 'Nosto', jobTitle: 'Head of Engineering', role: TOPICS[4] },
 { id: 'spk-41', name: 'Naomi Watanabe', bio: 'Visual merchandising technologist using AI to optimize product imagery and increase click-through rates.', company: 'Cloudinary', jobTitle: 'Director of Product', role: TOPICS[4] },
 { id: 'spk-67', name: 'Lily Hartwell', bio: 'Customer segmentation expert using machine learning to identify high-value cohorts for targeted campaigns.', company: 'Attentive', jobTitle: 'Director of Data Science', role: TOPICS[4] },
 { id: 'spk-64', name: 'Hassan El-Amin', bio: 'Customer service AI builder creating chatbots that resolve 70%+ of support tickets without human intervention.', company: 'Gorgias', jobTitle: 'Head of AI', role: TOPICS[4] },

 // ── Payments & Checkout (9) ───────────────────────────────────────────────
 { id: 'spk-11', name: 'Fatima Al-Rashid', bio: 'Subscription commerce pioneer with deep expertise in recurring revenue models for consumer brands.', company: 'Recharge', jobTitle: 'VP of Growth', role: TOPICS[5] },
 { id: 'spk-19', name: 'Rachel Kim', bio: 'Subscription management innovator building the infrastructure that powers millions of recurring orders.', company: 'Skio', jobTitle: 'Co-Founder', role: TOPICS[5] },
 { id: 'spk-22', name: 'Aisha Johnson', bio: 'Relationship commerce strategist transforming one-time buyers into lifelong subscribers.', company: 'Ordergroove', jobTitle: 'VP of Customer Success', role: TOPICS[5] },
 { id: 'spk-28', name: 'Yuki Sato', bio: 'Payment systems architect with expertise in global payment orchestration and checkout optimization.', company: 'Stripe', jobTitle: 'Commerce Lead', role: TOPICS[5] },
 { id: 'spk-44', name: 'Rafael Santos', bio: 'Fraud prevention expert protecting ecommerce brands from chargebacks while maintaining frictionless checkout.', company: 'Signifyd', jobTitle: 'Head of Data Science', role: TOPICS[5] },
 { id: 'spk-53', name: 'Chloe Martin', bio: 'Customer retention strategist using behavioral data to reduce churn and increase lifetime value.', company: 'Recharge', jobTitle: 'Head of Retention', role: TOPICS[5] },
 { id: 'spk-57', name: 'Tamara Novak', bio: 'Checkout optimization specialist who has recovered millions in abandoned cart revenue for DTC brands.', company: 'Bold Commerce', jobTitle: 'VP of Product', role: TOPICS[5] },
 { id: 'spk-63', name: 'Ling Wei', bio: 'Cross-border payments specialist simplifying international transactions for commerce brands.', company: 'Adyen', jobTitle: 'VP of Commerce', role: TOPICS[5] },
 { id: 'spk-38', name: 'Oscar Hernandez', bio: 'Mobile commerce architect who has built apps driving 60%+ of revenue for major DTC brands.', company: 'Tapcart', jobTitle: 'VP of Engineering', role: TOPICS[5] },

 // ── Brand & Experience (9) ────────────────────────────────────────────────
 { id: 'spk-10', name: 'Carlos Mendoza', bio: 'Customer experience strategist who has helped ecommerce brands achieve 95%+ CSAT scores through automation and empathy.', company: 'Gorgias', jobTitle: 'Head of CX Strategy', role: TOPICS[6] },
 { id: 'spk-13', name: 'Olivia Thompson', bio: 'Review and UGC expert helping brands leverage social proof to increase conversion rates by 30%+.', company: 'Yotpo', jobTitle: 'Director of Product', role: TOPICS[6] },
 { id: 'spk-21', name: 'Lucas Wright', bio: 'Social proof and customer marketing leader driving authentic brand advocacy through review programs.', company: 'Okendo', jobTitle: 'Director of Marketing', role: TOPICS[6] },
 { id: 'spk-27', name: 'Darius Jackson', bio: 'Brand storytelling strategist helping DTC companies build emotional connections that drive repeat purchases.', company: 'Glossier', jobTitle: 'VP of Brand', role: TOPICS[6] },
 { id: 'spk-29', name: 'Grace Obi', bio: 'Community commerce expert building the playbook for brands that turn customers into co-creators.', company: 'Depop', jobTitle: 'Head of Community', role: TOPICS[6] },
 { id: 'spk-31', name: 'Leila Ahmadi', bio: 'Beauty tech innovator building AR try-on experiences that have increased online beauty sales by 40%.', company: 'Kylie Cosmetics', jobTitle: 'Head of Digital Innovation', role: TOPICS[6] },
 { id: 'spk-33', name: 'Camille Laurent', bio: 'Luxury ecommerce strategist bridging the gap between high-touch retail and digital-first experiences.', company: 'Selfridges Digital', jobTitle: 'Head of Digital Commerce', role: TOPICS[6] },
 { id: 'spk-37', name: 'Mia Chen', bio: 'Content commerce expert building shoppable content strategies that blur the line between media and retail.', company: 'TikTok Shop', jobTitle: 'Head of Commerce Partnerships', role: TOPICS[6] },
 { id: 'spk-51', name: 'Esme Delacroix', bio: 'Luxury packaging and unboxing experience designer helping premium brands create memorable first impressions.', company: 'Packlane', jobTitle: 'Creative Director', role: TOPICS[6] },

 // ── Security & Infrastructure (9) ─────────────────────────────────────────
 { id: 'spk-1', name: 'Sarah Chen', bio: 'Principal engineer with 12 years of experience building distributed systems. Frequent conference speaker and open-source contributor.', company: 'CloudScale Inc.', jobTitle: 'Principal Engineer', role: TOPICS[7], twitterHandle: '@sarahchen' },
 { id: 'spk-4', name: 'James Okafor', bio: 'Security researcher and ethical hacker who helps companies find and fix vulnerabilities. Runs a popular security podcast.', company: 'SecureFoundry', jobTitle: 'Security Researcher', role: TOPICS[7] },
 { id: 'spk-24', name: 'Diana Okonkwo', bio: 'Cloud infrastructure strategist helping commerce brands scale globally with resilient architectures.', company: 'Google Cloud', jobTitle: 'Commerce Solutions Lead', role: TOPICS[7] },
 { id: 'spk-50', name: 'Jordan Taylor', bio: 'Social commerce strategist building seamless shopping experiences within social media platforms.', company: 'Meta', jobTitle: 'Commerce Product Lead', role: TOPICS[7] },
 { id: 'spk-55', name: 'Isabella Moretti', bio: 'Product photography and visual commerce expert building immersive 3D and video shopping experiences.', company: 'Bambuser', jobTitle: 'Head of Live Commerce', role: TOPICS[7] },
 { id: 'spk-62', name: 'Jake Morrison', bio: 'Headless commerce performance engineer obsessed with sub-second page loads and Core Web Vitals.', company: 'Vercel', jobTitle: 'Commerce DX Lead', role: TOPICS[7] },
 { id: 'spk-65', name: 'Victoria Strand', bio: 'Sustainable fashion technologist building circular commerce platforms for resale and rental.', company: 'ThredUp', jobTitle: 'VP of Engineering', role: TOPICS[7] },
 { id: 'spk-72', name: 'Derek Huang', bio: 'Commerce security expert protecting brands from account takeover, bot attacks, and payment fraud.', company: 'Signifyd', jobTitle: 'VP of Engineering', role: TOPICS[7] },
 { id: 'spk-35', name: 'Emma Johansson', bio: 'Sustainability in commerce advocate helping brands build transparent, eco-friendly supply chains.', company: 'Allbirds', jobTitle: 'VP of Sustainability', role: TOPICS[7] },
 ]
 ...
 update: {},
 create: { roomId: general.id, userId: u.id } }).catch(() => {}) // ignore if already exists
 }
 }
