...
async function main() {
  ...
  const speakerDefs: { id: string; name: string; bio: string; company: string; jobTitle: string; role: string; twitterHandle?: string; linkedinUrl?: string; photoUrl: string }[] = [
    ...
    { id: 'spk-56', name: 'Kevin Wu', bio: 'Inventory planning and demand forecasting expert helping brands eliminate stockouts and overstock.', company: 'Inventory Planner', jobTitle: 'CEO', role: TOPICS[0], photoUrl: 'https://images.unsplash.com/photo-1738566061883-1b568c74b550?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-25', name: 'Alex Nguyen', bio: 'Full-stack commerce developer and educator teaching brands how to build composable storefronts.', company: 'Shopify', jobTitle: 'Staff Developer Advocate', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1776111842991-4a189c07e609?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-32', name: 'Nathan Brooks', bio: 'Marketplace operations expert scaling multi-vendor platforms from startup to $100M+ GMV.', company: 'Faire', jobTitle: 'VP of Operations', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1769636929261-e913ed023c83?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-58', name: 'Brian Foster', bio: 'Composable commerce architect helping enterprise brands break free from monolithic platforms.', company: 'commercetools', jobTitle: 'Solutions Architect', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1758518729058-b158e71c5a9b?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-48', name: 'Finn O\'Connor', bio: 'Accessibility advocate ensuring ecommerce experiences are inclusive and WCAG-compliant.', company: 'Shopify', jobTitle: 'Accessibility Lead', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1729795795561-97daeedfec02?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-47', name: 'Aaliyah Davis', bio: 'Email marketing automation specialist driving 30%+ of revenue through lifecycle campaigns.', company: 'Klaviyo', jobTitle: 'Head of Email Strategy', role: TOPICS[2], photoUrl: 'https://images.unsplash.com/photo-1632612721400-0a337458b7ed?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-16', name: 'Kenji Tanaka', bio: 'Fulfillment network architect connecting brands with optimal 3PL partners across global markets.', company: 'Extensiv', jobTitle: 'CTO', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1614705660975-ce6ba7d731c7?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-20', name: 'Nadia Petrova', bio: 'Shipment tracking and logistics expert helping brands deliver transparency and trust at every touchpoint.', company: 'AfterShip', jobTitle: 'Head of Product', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1765005204268-631d9e0c6fe1?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-36', name: 'Andre Williams', bio: 'Warehouse automation specialist deploying robotics and AI to transform fulfillment center efficiency.', company: 'ShipBob', jobTitle: 'CTO', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1769636929231-3cd7f853d038?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-59', name: 'Ananya Gupta', bio: 'Voice commerce researcher exploring how conversational AI is reshaping how consumers discover and buy products.', company: 'Google Cloud', jobTitle: 'AI Research Lead', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1769636929130-56648d6e9c6d?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-69', name: 'Samira Youssef', bio: 'Product recommendation engine architect using collaborative filtering to boost cross-sell revenue.', company: 'Nosto', jobTitle: 'Head of Engineering', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1762505464553-1f4eb1578f23?w=3840&q=100&fit=crop&crop=face' },
    ...
    // ── Payments & Checkout (9) ───────────────────────────────────────────────
    { id: 'spk-11', name: 'Fatima Al-Rashid', bio: 'Subscription commerce pioneer with deep expertise in recurring revenue models for consumer brands.', company: 'Recharge', jobTitle: 'VP of Growth', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1745434159123-af6142c7862f?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-57', name: 'Tamara Novak', bio: 'Checkout optimization specialist who has recovered millions in abandoned cart revenue for DTC brands.', company: 'Bold Commerce', jobTitle: 'VP of Product', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1619369056679-87b6fbfac1be?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-38', name: 'Oscar Hernandez', bio: 'Mobile commerce architect who has built apps driving 60%+ of revenue for major DTC brands.', company: 'Tapcart', jobTitle: 'VP of Engineering', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1709004915887-0dec2f98c8de?w=3840&q=100&fit=crop&crop=face' },

    // ── Brand & Experience (9) ────────────────────────────────────────────────
    { id: 'spk-10', name: 'Carlos Mendoza', bio: 'Customer experience strategist who has helped ecommerce brands achieve 95%+ CSAT scores through automation and empathy.', company: 'Gorgias', jobTitle: 'Head of CX Strategy', role: TOPICS[6], photoUrl: 'https://images.unsplash.com/photo-1649712041612-021cf78bca23?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-29', name: 'Grace Obi', bio: 'Community commerce expert building the playbook for brands that turn customers into co-creators.', company: 'Depop', jobTitle: 'Head of Community', role: TOPICS[6], photoUrl: 'https://images.unsplash.com/photo-1617554980793-009061cdbb4f?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-31', name: 'Leila Ahmadi', bio: 'Beauty tech innovator building AR try-on experiences that have increased online beauty sales by 40%.', company: 'Kylie Cosmetics', jobTitle: 'Head of Digital Innovation', role: TOPICS[6], photoUrl: 'https://images.unsplash.com/photo-1631253205777-9f792356b1f4?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-51', name: 'Esme Delacroix', bio: 'Luxury packaging and unboxing experience designer helping premium brands create memorable first impressions.', company: 'Packlane', jobTitle: 'Creative Director', role: TOPICS[6], photoUrl: 'https://images.unsplash.com/photo-1676466672814-4ebeb415d9dc?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-24', name: 'Diana Okonkwo', bio: 'Cloud infrastructure strategist helping commerce brands scale globally with resilient architectures.', company: 'Google Cloud', jobTitle: 'Commerce Solutions Lead', role: TOPICS[7], photoUrl: 'https://images.unsplash.com/photo-1765005204227-bf58bcdd4449?w=3840&q=100&fit=crop&crop=face' },
    ...
    { id: 'spk-72', name: 'Derek Huang', bio: 'Commerce security expert protecting brands from account takeover, bot attacks, and payment fraud.', company: 'Signifyd', jobTitle: 'VP of Engineering', role: TOPICS[7], photoUrl: 'https://images.unsplash.com/photo-1600896997793-b8ed3459a17f?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-35', name: 'Emma Johansson', bio: 'Sustainability in commerce advocate helping brands build transparent, eco-friendly supply chains.', company: 'Allbirds', jobTitle: 'VP of Sustainability', role: TOPICS[7], photoUrl: 'https://images.unsplash.com/photo-1672527838035-90ae2ad2e813?w=3840&q=100&fit=crop&crop=face' },
  ]
