...
async function main() {
  ...
  const speakerDefs: { id: string; name: string; bio: string; company: string; jobTitle: string; role: string; twitterHandle?: string; linkedinUrl?: string; photoUrl: string }[] = [
    ...
    // ── AI & Data (9) ─────────────────────────────────────────────────────────
    { id: 'spk-2', name: 'Marcus Williams', bio: 'Leads the AI/ML platform team and has published research on large language models. Previously at Google Brain and OpenAI.', company: 'DeepTech Labs', jobTitle: 'Head of AI Platform', role: TOPICS[4], linkedinUrl: 'https://linkedin.com/in/marcuswilliams', photoUrl: 'https://images.unsplash.com/photo-1580411415491-a672219c801b?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-17', name: 'Ava Mitchell', bio: 'Personalization expert using AI to create unique shopping experiences that increase AOV and lifetime value.', company: 'Rebuy Engine', jobTitle: 'Head of AI', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1631377307479-99d966c84eff?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-18', name: 'Ibrahim Koné', bio: 'Site search and merchandising specialist who has optimized product discovery for 500+ online retailers.', company: 'Searchspring', jobTitle: 'VP of Engineering', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1549473448-fc2facc0615a?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-39', name: 'Zara Patel', bio: 'Customer data platform expert unifying first-party data to power hyper-personalized marketing.', company: 'Segment', jobTitle: 'Commerce Solutions Lead', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1573294705900-9623cfc746b7?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-59', name: 'Ananya Gupta', bio: 'Voice commerce researcher exploring how conversational AI is reshaping how consumers discover and buy products.', company: 'Google Cloud', jobTitle: 'AI Research Lead', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1648786221811-f1ce25534eb3?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-69', name: 'Samira Youssef', bio: 'Product recommendation engine architect using collaborative filtering to boost cross-sell revenue.', company: 'Nosto', jobTitle: 'Head of Engineering', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1676694047749-ee0fa2709893?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-41', name: 'Naomi Watanabe', bio: 'Visual merchandising technologist using AI to optimize product imagery and increase click-through rates.', company: 'Cloudinary', jobTitle: 'Director of Product', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1666577624653-b6f0043fed0e?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-67', name: 'Lily Hartwell', bio: 'Customer segmentation expert using machine learning to identify high-value cohorts for targeted campaigns.', company: 'Attentive', jobTitle: 'Director of Data Science', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1618645041616-51edd6add6d0?w=3840&q=100&fit=crop&crop=face' },
    { id: 'spk-64', name: 'Hassan El-Amin', bio: 'Customer service AI builder creating chatbots that resolve 70%+ of support tickets without human intervention.', company: 'Gorgias', jobTitle: 'Head of AI', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1644268756918-16348d1bc619?w=3840&q=100&fit=crop&crop=face' },
