...
async function main() {
  ...
  const speakerDefs: { id: string; name: string; bio: string; company: string; jobTitle: string; role: string; twitterHandle?: string; linkedinUrl?: string; photoUrl: string }[] = [
    ...
    { id: 'spk-3', name: 'Priya Patel', bio: 'CTO of a fast-growing fintech startup passionate about developer experience, platform engineering, and engineering cultures that scale.', company: 'FinFlow', jobTitle: 'CTO', role: TOPICS[0], twitterHandle: '@priyapatel_dev', photoUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-30', name: 'Patrick O\'Sullivan', bio: 'Retail analytics leader using data to predict trends, optimize inventory, and reduce markdowns.', company: 'SSENSE', jobTitle: 'Director of Analytics', role: TOPICS[0], photoUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-70', name: 'Ben Gallagher', bio: 'Retail analytics dashboard builder giving merchants real-time visibility into sales and inventory.', company: 'Looker', jobTitle: 'Commerce Analytics Lead', role: TOPICS[0], photoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-61', name: 'Rosa Fernandez', bio: 'Localization expert helping global brands adapt their storefronts for language, culture, and currency.', company: 'Weglot', jobTitle: 'Head of Commerce', role: TOPICS[0], photoUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-6', name: 'David Park', bio: 'Pioneering headless commerce architectures that power some of the fastest-growing DTC brands in North America.', company: 'BigCommerce', jobTitle: 'Director of Engineering', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-25', name: 'Alex Nguyen', bio: 'Full-stack commerce developer and educator teaching brands how to build composable storefronts.', company: 'Shopify', jobTitle: 'Staff Developer Advocate', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-40', name: 'Chris Bennett', bio: 'Headless CMS pioneer enabling brands to deliver content-rich commerce experiences across every channel.', company: 'Contentful', jobTitle: 'Head of Commerce', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-58', name: 'Brian Foster', bio: 'Composable commerce architect helping enterprise brands break free from monolithic platforms.', company: 'commercetools', jobTitle: 'Solutions Architect', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-68', name: 'Adrian Pope', bio: 'API-first commerce builder helping brands create custom storefronts with maximum flexibility.', company: 'Medusa', jobTitle: 'Co-Founder', role: TOPICS[1], photoUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-47', name: 'Aaliyah Davis', bio: 'Email marketing automation specialist driving 30%+ of revenue through lifecycle campaigns.', company: 'Klaviyo', jobTitle: 'Head of Email Strategy', role: TOPICS[2], photoUrl: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-7', name: 'Amira Hassan', bio: 'Supply chain optimization expert helping brands reduce fulfillment costs while improving delivery speed.', company: 'ShipStation', jobTitle: 'Head of Product', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1614644147724-2d4785d69962?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-15', name: 'Sophie Dubois', bio: 'Post-purchase experience designer focused on turning shipping anxiety into brand loyalty moments.', company: 'Narvar', jobTitle: 'Head of Experience Design', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1598550874175-4d0ef436c909?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-16', name: 'Kenji Tanaka', bio: 'Fulfillment network architect connecting brands with optimal 3PL partners across global markets.', company: 'Extensiv', jobTitle: 'CTO', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-36', name: 'Andre Williams', bio: 'Warehouse automation specialist deploying robotics and AI to transform fulfillment center efficiency.', company: 'ShipBob', jobTitle: 'CTO', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1590086782957-93c06ef21604?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-49', name: 'Priyanka Sharma', bio: 'Warehouse management systems expert optimizing pick, pack, and ship operations for high-volume brands.', company: 'ShipStation', jobTitle: 'Director of Solutions', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1601455763557-db1bea8a9a5a?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-71', name: 'Chiara Bianchi', bio: 'Omnichannel fulfillment strategist helping brands offer BOPIS, ship-from-store, and same-day delivery.', company: 'Manhattan Associates', jobTitle: 'Director of Product', role: TOPICS[3], photoUrl: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-39', name: 'Zara Patel', bio: 'Customer data platform expert unifying first-party data to power hyper-personalized marketing.', company: 'Segment', jobTitle: 'Commerce Solutions Lead', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1611432579699-484f7990b127?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-59', name: 'Ananya Gupta', bio: 'Voice commerce researcher exploring how conversational AI is reshaping how consumers discover and buy products.', company: 'Google Cloud', jobTitle: 'AI Research Lead', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1580894894513-541e068a3e2b?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-64', name: 'Hassan El-Amin', bio: 'Customer service AI builder creating chatbots that resolve 70%+ of support tickets without human intervention.', company: 'Gorgias', jobTitle: 'Head of AI', role: TOPICS[4], photoUrl: 'https://images.unsplash.com/photo-1566492031773-4f4e44671857?w=800&q=85&fit=crop&crop=face' },

    // ── Payments & Checkout (9) ───────────────────────────────────────────────
    { id: 'spk-11', name: 'Fatima Al-Rashid', bio: 'Subscription commerce pioneer with deep expertise in recurring revenue models for consumer brands.', company: 'Recharge', jobTitle: 'VP of Growth', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-19', name: 'Rachel Kim', bio: 'Subscription management innovator building the infrastructure that powers millions of recurring orders.', company: 'Skio', jobTitle: 'Co-Founder', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-22', name: 'Aisha Johnson', bio: 'Relationship commerce strategist transforming one-time buyers into lifelong subscribers.', company: 'Ordergroove', jobTitle: 'VP of Customer Success', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1551836022-deb4988cc6c0?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-28', name: 'Yuki Sato', bio: 'Payment systems architect with expertise in global payment orchestration and checkout optimization.', company: 'Stripe', jobTitle: 'Commerce Lead', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-53', name: 'Chloe Martin', bio: 'Customer retention strategist using behavioral data to reduce churn and increase lifetime value.', company: 'Recharge', jobTitle: 'Head of Retention', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-57', name: 'Tamara Novak', bio: 'Checkout optimization specialist who has recovered millions in abandoned cart revenue for DTC brands.', company: 'Bold Commerce', jobTitle: 'VP of Product', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-38', name: 'Oscar Hernandez', bio: 'Mobile commerce architect who has built apps driving 60%+ of revenue for major DTC brands.', company: 'Tapcart', jobTitle: 'VP of Engineering', role: TOPICS[5], photoUrl: 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=800&q=85&fit=crop&crop=face' },

    // ── Brand & Experience (9) ────────────────────────────────────────────────
    { id: 'spk-10', name: 'Carlos Mendoza', bio: 'Customer experience strategist who has helped ecommerce brands achieve 95%+ CSAT scores through automation and empathy.', company: 'Gorgias', jobTitle: 'Head of CX Strategy', role: TOPICS[6], photoUrl: 'https://images.unsplash.com/photo-1600878459138-e1123b37cb30?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-13', name: 'Olivia Thompson', bio: 'Review and UGC expert helping brands leverage social proof to increase conversion rates by 30%+.', company: 'Yotpo', jobTitle: 'Director of Product', role: TOPICS[6], photoUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-1', name: 'Sarah Chen', bio: 'Principal engineer with 12 years of experience building distributed systems. Frequent conference speaker and open-source contributor.', company: 'CloudScale Inc.', jobTitle: 'Principal Engineer', role: TOPICS[7], twitterHandle: '@sarahchen', photoUrl: 'https://images.unsplash.com/photo-1598550880863-4e8aa3d0edb4?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-24', name: 'Diana Okonkwo', bio: 'Cloud infrastructure strategist helping commerce brands scale globally with resilient architectures.', company: 'Google Cloud', jobTitle: 'Commerce Solutions Lead', role: TOPICS[7], photoUrl: 'https://images.unsplash.com/photo-1594744803329-e58b31de8bf5?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-55', name: 'Isabella Moretti', bio: 'Product photography and visual commerce expert building immersive 3D and video shopping experiences.', company: 'Bambuser', jobTitle: 'Head of Live Commerce', role: TOPICS[7], photoUrl: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=800&q=85&fit=crop&crop=face' },
    ...
    { id: 'spk-65', name: 'Victoria Strand', bio: 'Sustainable fashion technologist building circular commerce platforms for resale and rental.', company: 'ThredUp', jobTitle: 'VP of Engineering', role: TOPICS[7], photoUrl: 'https://images.unsplash.com/photo-1607746882042-944635dfe10e?w=800&q=85&fit=crop&crop=face' },
    { id: 'spk-72', name: 'Derek Huang', bio: 'Commerce security expert protecting brands from account takeover, bot attacks, and payment fraud.', company: 'Signifyd', jobTitle: 'VP of Engineering', role: TOPICS[7], photoUrl: 'https://images.unsplash.com/photo-1618077360395-f3068be8e001?w=800&q=85&fit=crop&crop=face' },
