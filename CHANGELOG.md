...
*Was four until 2026-08-01, when the fifth was found while writing the assertions for the stale-company fix and closed in the same piece of work.*
...
Fixed 2026-08-01. Both answer 404, matching what reading the same form already answered. Verified first that the portal's own screen tests only whether the response succeeded and never reads the count, so it keeps behaving correctly.
