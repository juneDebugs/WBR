        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 border border-white/10 rounded-xl p-4">
            ...
            <div className="space-y-2 text-xs text-gray-500">
              <p><span className="text-gray-400">Attendee:</span> jordan@demo.com / demo123</p>
              <p><span className="text-gray-400">Sponsor:</span> sponsor@shopify.com / sponsor123</p>
              <p><span className="text-gray-400">Sponsor:</span> sponsor@klaviyo.com / sponsor123</p>
