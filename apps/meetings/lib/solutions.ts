...
// ── People Categories (high-level groupings for the People page) ─────────────
...
const INDUSTRY_TO_CATEGORY: Record<Industry, PeopleCategory | null> = {
...
export function getPeopleCategory(company: string | null | undefined): PeopleCategory | null {
  return INDUSTRY_TO_CATEGORY[getIndustry(company)]
}
