...
export default async function MeetingDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="page-container">
      <Link href="/meetings" className="flex items-center gap-1 text-primary text-sm mb-4">
          ...
          {meeting.notes && (
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 mt-0.5">{meeting.notes}</p>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="card">
        <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Meeting With</h2>
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            {other.bio && (
              <p className="text-sm text-gray-600 mt-2 leading-relaxed">{other.bio}</p>
            )}
          </div>
        </div>
      </div>
